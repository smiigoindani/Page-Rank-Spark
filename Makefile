...
# -----------------------------------------------------------
spark.root=/Users/simrangoindani/Downloads/spark-2.4.8-bin-without-hadoop
hadoop.root=/Users/simrangoindani/work/hadoop-2.10.1
app.name=PageRank RDD
jar.name=spark-demo.jar
maven.jar.name=spark-demo-1.0.jar
job.name=pr.PageRank_RDD
...
local: jar clean-local-output
	spark-submit --class ${job.name} --driver-java-options "-Dlog4j.configuration=file:/Users/simrangoindani/Downloads/spark-2.4.8-bin-without-hadoop/conf/log4j.properties.template" --conf "spark.executor.extraJavaOptions=-Dlog4j.configuration=file:/Users/simrangoindani/Downloads/spark-2.4.8-bin-without-hadoop/conf/log4j.properties.template" --master ${local.master} --name "${app.name}" ${jar.name} ${local.input} ${local.output}
